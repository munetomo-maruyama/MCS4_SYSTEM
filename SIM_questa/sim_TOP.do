...
vlog \
    ...
    +define+sg75         \
    +define+x16          \
    $DIR_RTL_MCS4_SYS/mcs4_cpu.v      \
    $DIR_RTL_MCS4_SYS/mcs4_sys.v      \
    $DIR_RTL_MCS4_SYS/mcs4_rom.v      \
    ...
    $DIR_RTL_RISCV/ram/rami.v  \
    $DIR_RTL_RISCV/ram/ramd.v  \
...
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/use_external_mcs4_cpu
...
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_SYS/DATA_I
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_SYS/DATA_O
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_SYS/DATA_OE
...
# CPU_CHIP
add wave -divider MCS4_CPU
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/CLK
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/RES_N
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/SYNC_N
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/DATA_I
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/DATA_O
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/DATA_OE
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/CM_ROM_N
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/CM_RAM_N
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_MCS4_CPU/TEST
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/c_mcs4_data_i
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/c_mcs4_data_o
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/c_mcs4_data_oe
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/s_mcs4_data_i
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/s_mcs4_data_o
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/s_mcs4_data_oe
...
add wave -position end  sim:/TB_TOP/res_sys_n
add wave -position end  sim:/TB_TOP/tb_reset_halt_n
add wave -position end  sim:/TB_TOP/gpio2
add wave -position end  sim:/TB_TOP/U_FPGA_TOP/U_RISCV_TOP/RESET_HALT_N
