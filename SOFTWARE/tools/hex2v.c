//===========================================================
// MAX10 Support Program
//-----------------------------------------------------------
// File Name   : hex2v.c
// Description : Convert Intel Hex to $readmemh format
//-----------------------------------------------------------
// History :
// Rev.01 2015.10.12 M.Maruyama First Release
//-----------------------------------------------------------
...
uint32_t Read_Hex_Format(FILE *fp)
{
    ...
    while(1)
    {
        ...
        if (strcmp(str, "02") == 0)
        {
            ...
            str[1] = *pline++;
            str[2] = '\0';
            if (sscanf(str, "%02X", (int*)&addr_base) == EOF) {error = 4; break;}
        ...
        if (strcmp(str, "04") == 0)
        {
            ...
            str[1] = *pline++;
            str[2] = '\0';
            if (sscanf(str, "%02X", (int*)&addr_base) == EOF) {error = 5; break;}
