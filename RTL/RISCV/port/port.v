...
// 0x14   PDR4 Port Data Register 5
...
// 0x34   PDD4 Port Data Direction 5
//                 0 : Input 
//                 1 : Output
//======================================================
...
reg  [31:0] pdr5; // Port Data Register 5
...
reg  [31:0] pdd5; // Port Data Direction 5
//
reg         dphase_active;
...
begin
    ...
    begin
        ...
        if (dphase_addr[5:2] == 4'b0101) pdr5 <= S_HWDATA;
    end
end
//
always @(posedge CLK, posedge RES)
begin
    ...
    begin
        ...
        if (dphase_addr[5:2] == 4'b1101) pdd5 <= S_HWDATA;
    end
end
//
always @*
begin
    ...
    begin
        ...
        else if (dphase_addr[5:2] == 4'b0101) S_HRDATA = gpio5_rd;
        ...
        else if (dphase_addr[5:2] == 4'b1101) S_HRDATA = pdd5;
...
begin
    ...
    begin
        ...
        gpio5_rd[i] = (pdd5[i])? pdr5[i] : GPIO5_I[i];
    end
end
//
assign GPIO0_O = pdr0;
