...
// GPIO1[24] A11 LEDR8
// GPIO1[25] B11 LEDR9
// GPIO1[26] AA5 GPIO1[26] TT_SEL_INC
...
//
// GPIO5[ 0] s_mcs4_rom_init_rdata[ 0] input
// GPIO5[ 1] s_mcs4_rom_init_rdata[ 1] input
// GPIO5[ 2] s_mcs4_rom_init_rdata[ 2] input
// GPIO5[ 3] s_mcs4_rom_init_rdata[ 3] input
// GPIO5[ 4] s_mcs4_rom_init_rdata[ 4] input
// GPIO5[ 5] s_mcs4_rom_init_rdata[ 5] input
// GPIO5[ 6] s_mcs4_rom_init_rdata[ 6] input
// GPIO5[ 7] s_mcs4_rom_init_rdata[ 7] input
// GPIO5[ 8] s_mcs4_rom_init_wdata[ 0] output
// GPIO5[ 9] s_mcs4_rom_init_wdata[ 1] output
// GPIO5[10] s_mcs4_rom_init_wdata[ 2] output
// GPIO5[11] s_mcs4_rom_init_wdata[ 3] output
// GPIO5[12] s_mcs4_rom_init_wdata[ 4] output
// GPIO5[13] s_mcs4_rom_init_wdata[ 5] output
// GPIO5[14] s_mcs4_rom_init_wdata[ 6] output
// GPIO5[15] s_mcs4_rom_init_wdata[ 7] output
// GPIO5[16] s_mcs4_rom_init_addr [ 0] output
// GPIO5[17] s_mcs4_rom_init_addr [ 1] output
// GPIO5[18] s_mcs4_rom_init_addr [ 2] output
// GPIO5[19] s_mcs4_rom_init_addr [ 3] output
// GPIO5[20] s_mcs4_rom_init_addr [ 4] output
// GPIO5[21] s_mcs4_rom_init_addr [ 5] output
// GPIO5[22] s_mcs4_rom_init_addr [ 6] output
// GPIO5[23] s_mcs4_rom_init_addr [ 7] output
// GPIO5[24] s_mcs4_rom_init_addr [ 8] output
// GPIO5[25] s_mcs4_rom_init_addr [ 9] output
// GPIO5[26] s_mcs4_rom_init_addr [10] output
// GPIO5[27] s_mcs4_rom_init_addr [11] output
// GPIO5[28] s_mcs4_rom_init_re        output
// GPIO5[29] s_mcs4_rom_init_we        output
// GPIO5[30] s_mcs4_rom_init_enb       output
// GPIO5[31] s_mcs4_res_n              output
...
//--------------------------
`ifdef SIMULATION
    `define POR_MAX 16'd05000 // period of power on reset 
`else  // Real FPGA
    `define POR_MAX 16'd50000 // period of power on reset 
`endif
...
//--------------------------------------------------
// MCS4 CPU Connection (externally or internally)
//--------------------------------------------------
wire use_external_mcs4_cpu; // Use MCS4 CPU connected externally
//
wire       c_mcs4_clk;
wire       c_mcs4_res_n;
wire       c_mcs4_sync_n;
wire       c_mcs4_test;
wire [3:0] c_mcs4_data_i;
wire [3:0] c_mcs4_data_o;
wire       c_mcs4_data_oe;
wire       c_mcs4_cm_rom_n;
wire [3:0] c_mcs4_cm_ram_n;
//
wire       s_mcs4_clk;
wire       s_mcs4_res_n;
wire       s_mcs4_sync_n;
wire       s_mcs4_test;
wire [3:0] s_mcs4_data_i;
wire [3:0] s_mcs4_data_o;
wire       s_mcs4_data_oe;
...
//-----------------------------------------
wire        s_mcs4_rom_init_enb;
wire [11:0] s_mcs4_rom_init_addr;
wire        s_mcs4_rom_init_we;
wire        s_mcs4_rom_init_re;
wire [ 7:0] s_mcs4_rom_init_wdata;
wire [ 7:0] s_mcs4_rom_init_rdata;
...
(
    ...
    //
    .DATA_I   (c_mcs4_data_i ), // Data Input
    .DATA_O   (c_mcs4_data_o ), // Data Output
    .DATA_OE  (c_mcs4_data_oe), // Data Output Enable
    //
...
(
    ...
    //
    .DATA_I   (s_mcs4_data_i ), // Data Input
    .DATA_O   (s_mcs4_data_o ), // Data Output
    .DATA_OE  (s_mcs4_data_oe), // Data Output Enable
    //
    .CM_ROM_N (s_mcs4_cm_rom_n), // Memory Control for ROM
    .CM_RAM_N (s_mcs4_cm_ram_n), // Memory Control for RAM
    ...
    .ROM_INIT_ENB   (s_mcs4_rom_init_enb),
    .ROM_INIT_ADDR  (s_mcs4_rom_init_addr),
    .ROM_INIT_RE    (s_mcs4_rom_init_re),
    .ROM_INIT_WE    (s_mcs4_rom_init_we),
    .ROM_INIT_WDATA (s_mcs4_rom_init_wdata),
    .ROM_INIT_RDATA (s_mcs4_rom_init_rdata)    
);
...
wire [31:0] gpio5_oe;
//
assign use_external_mcs4_cpu = gpio2_i[ 9]; // SW9
assign reset_halt_n          = gpio2_i[10]; // KEY1
//
generate
    for (i = 0; i < 32; i = i + 1)
    begin : IOBUF_GPIO0
    ...
    for (i = 16; i < 26; i = i + 1)
    begin : IOBUF_GPIO11
        assign gpio1_i[i] = pc[i-16+2]; // PC[11:2]
        assign GPIO1[i] = pc[i-16+2];   // PC[11:2]
    end
    //
    for (i = 26; i < 29; i = i + 1)
    begin : IOBUF_GPIO12
...
//---------------------------------------
// MCS4 ROM Initialization from RISC-V
//---------------------------------------
assign s_mcs4_res_n        = (gpio5_oe[31])? gpio5_o[31] : 1'b0;
assign s_mcs4_rom_init_enb = (gpio5_oe[30])? gpio5_o[30] : 1'b0;
assign s_mcs4_rom_init_we  = (gpio5_oe[29])? gpio5_o[29] : 1'b0;
assign s_mcs4_rom_init_re  = (gpio5_oe[28])? gpio5_o[28] : 1'b0;
//
generate
    for (i = 0; i < 8; i = i + 1)
    begin : IOBUF_GPIO5_7_0
        assign gpio5_i[i] = s_mcs4_rom_init_rdata[i];
    end
    //
    for (i = 0; i < 8; i = i + 1)
    begin : IOBUF_GPIO5_15_8
        assign gpio5_i[i+8] = s_mcs4_rom_init_wdata[i];
        assign s_mcs4_rom_init_wdata[i] = (gpio5_oe[i+8])? gpio5_o[i+8] : 1'b0;
    end
    //
    for (i = 0; i < 12; i = i + 1)
    begin : IOBUF_GPIO5_27_16
        assign gpio5_i[i+16] = s_mcs4_rom_init_addr[i];
        assign s_mcs4_rom_init_addr[i] = (gpio5_oe[i+16])? gpio5_o[i+16] : 1'b0;
    end
endgenerate
